export default function Background() {
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden bg-gray-950">
      <div className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-violet-900/20 rounded-full blur-[120px] animate-pulse" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40vw] h-[40vw] bg-blue-900/20 rounded-full blur-[120px] animate-pulse delay-1000" />
      <div className="absolute top-[40%] left-[30%] w-[30vw] h-[30vw] bg-emerald-900/10 rounded-full blur-[100px] animate-pulse delay-700" />
