...
export default function ProjectDetails() {
  ...
  if (!project) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-ink-950 p-6 text-center text-slate-100">
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-ink-950 pb-24 text-slate-100">
      ...
      <div className="relative z-10">
        <div className="relative h-[58vh] overflow-hidden border-b border-white/10">
          <div className="absolute left-6 top-8 z-30 lg:left-12">
            <button
              onClick={() => navigate(-1)}
              className="inline-flex items-center gap-2 rounded-md border border-white/12 bg-ink-950 px-4 py-2 text-sm text-slate-200 transition-colors hover:border-white/30 hover:text-white"
            >
              <FaArrowLeft />
          ...
          <div className="absolute bottom-0 left-0 w-full px-6 pb-12 lg:px-12">
            <div className="mx-auto max-w-6xl">
              <span className="inline-block rounded-full border border-accent-300/20 bg-accent-300/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.24em] text-accent-200">
                {project.category}
              </span>
        ...
        <div className="mx-auto grid max-w-6xl gap-12 px-6 pt-16 lg:grid-cols-3 lg:px-12">
          <div className="space-y-14 lg:col-span-2">
            <div className="flex flex-wrap gap-4 border-b border-white/10 pb-10">
              ...
              {project.liveUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-3 rounded-2xl bg-accent-300 px-6 py-4 text-slate-950 transition-transform hover:-translate-y-0.5"
                >
            ...
            <section>
              <h2 className="mb-8 flex items-center gap-3 text-3xl font-semibold text-white">
                <FaLayerGroup className="text-accent-200" />
                Overview
              </h2>
            ...
            <section className="rounded-lg border border-white/10 p-6">
              ...
              <ul className="grid gap-5 md:grid-cols-2">
                {project.features.map((feature) => (
                  ...
                  >
                    <span className="mt-2 h-2 w-2 rounded-full bg-accent-300" />
          ...
          <div className="space-y-8">
            <div className="sticky top-20 rounded-lg border border-white/10 p-6">
              <h3 className="mb-8 flex items-center gap-3 text-xl font-semibold text-white">
                <FaTools className="text-accent-200" />
                Stack
              </h3>
              ...
              <div className="mt-10 border-t border-white/10 pt-8">
                ...
                <div className="flex items-center gap-4 rounded-2xl border border-white/10 bg-white/5 p-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-accent-300/10 text-accent-200">
                    <FaCalendarAlt />
                  </div>
                  <div>
